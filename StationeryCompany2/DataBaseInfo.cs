...
namespace StationeryCompany2
{
    ...
    private static void OpenDataBase()
    {
        ...
        {
            RunSql("SELECT * FROM vw_InfoProducts", "Информация о канцтоварах", out _);
        }
        //Добавление товара
        public static void InsertProduct()
        {
            try
            {
                ...
                Console.WriteLine("--------------------------------------");
                RunSql("SELECT * FROM TypeProduct", "Таблица типов канцтовара", out int countTypeProduct);
                if (countSupplier == 0 || countTypeProduct == 0)
                {
                    Console.WriteLine("Добавление новых канцтоваров не возможна, т.к. не существуют поставщиков или типов канцтовара");
                }
                else
                {
                    Console.Write("Введите название канцтовара: ");
                    string name = Console.ReadLine();
                    Console.Write("Введите остаток канцтовара: ");
                    int balance = Convert.ToInt32(Console.ReadLine());
                    Console.Write("Введите себестоимость канцтовара: ");
                    decimal costPrice = Convert.ToDecimal(Console.ReadLine());
                    Console.Write("Введите последнюю дату поставки канцтовара: ");
        ...
        public static void UpdateProduct()
        {
            try
            {
                RunSql("SELECT * FROM Products", "Таблица канцтоваров", out int countProducts);
                Console.WriteLine("--------------------------------------");
                RunSql("SELECT * FROM Suppliers", "Таблица поставщиков", out int countSupplier);
                Console.WriteLine("--------------------------------------");
                RunSql("SELECT * FROM TypeProduct", "Таблица типов канцтовара", out int countTypeProduct);
                ...
                {
                    Console.WriteLine("Обновление информации о товаре не возможна, т.к. не существуют поставщиков или типов канцтовара или канцтоваров");
                }
                else
                {
                    Console.Write("ВВедите id канцтовара, информацию о котором вы хотите обновить: ");
                    int productId = Convert.ToInt32(Console.ReadLine());
                    Console.Write("Введите новое название канцтовара: ");
                    string name = Console.ReadLine();
                    Console.Write("Введите новый остаток канцтовара: ");
                    int balance = Convert.ToInt32(Console.ReadLine());
                    Console.Write("Введите новую себестоимость канцтовара: ");
                    decimal costPrice = Convert.ToDecimal(Console.ReadLine());
                    Console.Write("Введите новую последнюю дату поставки канцтовара: ");
                    DateTime lastDateDelivery = Convert.ToDateTime(Console.ReadLine());
        ...
        public static void DeleteProduct()
        {
            try
            {
                RunSql("SELECT * FROM Products", "Таблица канцтоваров", out int rowCount);
                if (rowCount == 0)
                {
                ...
                {
                    Console.Write("Введите Id канцтовара, который вы хотите удалить: ");
                    int productId = Convert.ToInt32(Console.ReadLine());
        ...
        //Информация о типах канцтоваров
        public static void InfoTypeProduct()
        {
            RunSql("SELECT * FROM TypeProduct", "Таблица типа канцтоваров", out _);
        }
        //Добавление типа канцтовара
        public static void InsertTypeProduct()
        {
            Console.Write("Введите наименование типа канцтовара: ");
            string name = Console.ReadLine();
        ...
        public static void UpdateTypeProduct()
        {
            try
            {
                RunSql("SELECT * FROM TypeProduct", "Таблица типа канцтоваров", out int rowCount);
                if (rowCount == 0)
                {
                    Console.WriteLine("Нет данных. Продолжение не возможно");
                }
        ...
        #region Показать информацию о поставщике с наибольшим количеством канцтоваров на складе
        ...
        #region Показать информацию о поставщике с наименьшим количеством канцтоваров на складе
        ...
        #region Показать информацию о типе товаров с наибольшим количеством канцтоваров на складе
        ...
        #region Показать информацию о типе товаров с наименьшим количеством канцтоваров на складе
        ...
        #region Показать канцтовары с поставки, которых прошло заданное количество дней
        public static void InfoProductDeliveryPassedNumberDays()
        {
            try
            {
                ...
                RunSql($"SELECT * FROM vw_InfoProducts WHERE DATEDIFF(dd,[Last date delivery], GETDATE())>={countDays}", $"Информация о канцтоварах, с поставки которых прошло больше либо равно {countDays} дней", out _);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
