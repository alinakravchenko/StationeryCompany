...
VALUES ('ООО Пишу Красиво'),
	   ('ООО Диктуй правильно');
GO

INSERT INTO Products([Name], Balance, CostPrice, LastDateDelivery, TypeProductId, SupplierId)
VALUES ('Карандаш', 100, 5.65, '20220501', 1, 1),
	   ('Тетрадь в клетку', 200, 7.65, '20220701', 1, 1),
	   ('Блокнот"', 30, 11.25, GETDATE(), 2, 2),
	   ('Корректор"', 10, 20.2, '20221122', 2, 2);
GO
